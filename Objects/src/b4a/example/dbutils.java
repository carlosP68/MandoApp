...
anywheresoftware.b4a.keywords.Common.LogImpl("63080206","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64063237","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("64063247","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63145730","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63735559","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63670024","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63670039","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("63342344","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63342346","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63276806","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63211268","Same Map found twice in list. Each item in the list should include a different map object.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("63211292","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("63211297",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("63997698","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63997702","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("63997723","UpdateRecord: "+_sb.ToString(),0);
