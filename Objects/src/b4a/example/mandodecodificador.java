...
public class mandodecodificador extends Activity implements B4AActivity{
	public static mandodecodificador mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.mandodecodificador");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mandodecodificador).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.mandodecodificador");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.mandodecodificador", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mandodecodificador) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mandodecodificador) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return mandodecodificador.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (mandodecodificador) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (mandodecodificador) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            mandodecodificador mc = mostCurrent;
...
public anywheresoftware.b4a.objects.ButtonWrapper _botonnumerico = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 44;BA.debugLine="Activity.LoadLayout(\"layoutMandoDecoder\")";
mostCurrent._activity.LoadLayout("layoutMandoDecoder",mostCurrent.activityBA);
 //BA.debugLineNum = 45;BA.debugLine="Activity.SetBackgroundImage(LoadBitmap(File.DirAs";
mostCurrent._activity.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"bg.jpg").getObject()));
 //BA.debugLineNum = 46;BA.debugLine="myIp=server.GetMyWifiIP";
_myip = _server.GetMyWifiIP();
 //BA.debugLineNum = 47;BA.debugLine="ConectarServidor";
_conectarservidor();
...
public static String  _botonabajo_click() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Private Sub BotonAbajo_Click";
 //BA.debugLineNum = 100;BA.debugLine="transmiTrama(14)";
_transmitrama((int) (14));
 //BA.debugLineNum = 101;BA.debugLine="End Sub";
return "";
}
public static String  _botonarriba_click() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Private Sub BotonArriba_Click";
 //BA.debugLineNum = 103;BA.debugLine="transmiTrama(13)";
_transmitrama((int) (13));
 //BA.debugLineNum = 104;BA.debugLine="End Sub";
return "";
}
public static String  _botoncanalabajo_click() throws Exception{
 //BA.debugLineNum = 111;BA.debugLine="Private Sub BotonCanalAbajo_Click";
 //BA.debugLineNum = 112;BA.debugLine="transmiTrama(6)";
_transmitrama((int) (6));
 //BA.debugLineNum = 113;BA.debugLine="End Sub";
return "";
}
public static String  _botoncanalarriba_click() throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Private Sub BotonCanalArriba_Click";
 //BA.debugLineNum = 115;BA.debugLine="transmiTrama(5)";
_transmitrama((int) (5));
 //BA.debugLineNum = 116;BA.debugLine="End Sub";
return "";
}
public static String  _botonderecha_click() throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Private Sub BotonDerecha_Click";
 //BA.debugLineNum = 94;BA.debugLine="transmiTrama(16)";
_transmitrama((int) (16));
 //BA.debugLineNum = 95;BA.debugLine="End Sub";
return "";
}
public static String  _botongrabarteclas_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Private Sub BotonGrabarTeclas_Click";
 //BA.debugLineNum = 144;BA.debugLine="StartActivity(GrabarTeclasDecoder)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._grabarteclasdecoder.getObject()));
 //BA.debugLineNum = 145;BA.debugLine="Socket1.Close";
_socket1.Close();
...
public static String  _botonguia_click() throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Private Sub BotonGuia_Click";
 //BA.debugLineNum = 124;BA.debugLine="transmiTrama(8)";
_transmitrama((int) (8));
 //BA.debugLineNum = 125;BA.debugLine="End Sub";
return "";
}
public static String  _botonizquierda_click() throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Private Sub BotonIzquierda_Click";
 //BA.debugLineNum = 97;BA.debugLine="transmiTrama(15)";
_transmitrama((int) (15));
 //BA.debugLineNum = 98;BA.debugLine="End Sub";
return "";
}
public static String  _botonmas_click() throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Private Sub BotonMas_Click";
 //BA.debugLineNum = 109;BA.debugLine="transmiTrama(3)";
_transmitrama((int) (3));
 //BA.debugLineNum = 110;BA.debugLine="End Sub";
return "";
}
public static String  _botonmenos_click() throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Private Sub BotonMenos_Click";
 //BA.debugLineNum = 106;BA.debugLine="transmiTrama(4)";
_transmitrama((int) (4));
 //BA.debugLineNum = 107;BA.debugLine="End Sub";
return "";
}
public static String  _botonmenu_click() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Private Sub BotonMenu_Click";
 //BA.debugLineNum = 130;BA.debugLine="transmiTrama(9)";
_transmitrama((int) (9));
 //BA.debugLineNum = 131;BA.debugLine="End Sub";
return "";
}
public static String  _botonmute_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Private Sub BotonMute_Click";
 //BA.debugLineNum = 133;BA.debugLine="transmiTrama(11)";
_transmitrama((int) (11));
 //BA.debugLineNum = 134;BA.debugLine="End Sub";
return "";
}
public static String  _botonnumerico_click() throws Exception{
 //BA.debugLineNum = 148;BA.debugLine="Private Sub BotonNumerico_Click";
 //BA.debugLineNum = 149;BA.debugLine="StartActivity(MandoDecoderNumerico)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._mandodecodernumerico.getObject()));
 //BA.debugLineNum = 150;BA.debugLine="Socket1.Close";
_socket1.Close();
...
public static String  _botonok_click() throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Private Sub BotonOk_Click";
 //BA.debugLineNum = 91;BA.debugLine="transmiTrama(12)";
_transmitrama((int) (12));
 //BA.debugLineNum = 92;BA.debugLine="End Sub";
return "";
}
public static String  _botonpower_click() throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Private Sub BotonPower_Click";
 //BA.debugLineNum = 118;BA.debugLine="transmiTrama(1)";
_transmitrama((int) (1));
 //BA.debugLineNum = 119;BA.debugLine="End Sub";
return "";
}
public static String  _botonpowerdeco_click() throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Private Sub BotonPowerDeco_Click";
 //BA.debugLineNum = 136;BA.debugLine="transmiTrama(2)";
_transmitrama((int) (2));
 //BA.debugLineNum = 137;BA.debugLine="End Sub";
return "";
}
public static String  _botonprev_click() throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Private Sub BotonPrev_Click";
 //BA.debugLineNum = 121;BA.debugLine="transmiTrama(10)";
_transmitrama((int) (10));
 //BA.debugLineNum = 122;BA.debugLine="End Sub";
return "";
}
public static String  _botontvav_click() throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Private Sub BotonTvAv_Click";
 //BA.debugLineNum = 127;BA.debugLine="transmiTrama(7)";
_transmitrama((int) (7));
 //BA.debugLineNum = 128;BA.debugLine="End Sub";
return "";
}
public static String  _botonvolver_click() throws Exception{
 //BA.debugLineNum = 138;BA.debugLine="Private Sub BotonVolver_Click";
 //BA.debugLineNum = 139;BA.debugLine="StartActivity(SeleccionarMando)";
...
public static String  _conectarservidor() throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Sub ConectarServidor";
 //BA.debugLineNum = 65;BA.debugLine="Try";
try { //BA.debugLineNum = 66;BA.debugLine="If Datos_Validos = False Then Return";
if (_datos_validos()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 68;BA.debugLine="If Socket1.IsInitialized = False Then";
if (_socket1.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 69;BA.debugLine="Socket1.Initialize(\"Socket1\")";
_socket1.Initialize("Socket1");
 }else {
 //BA.debugLineNum = 71;BA.debugLine="Socket1.Close";
_socket1.Close();
 //BA.debugLineNum = 72;BA.debugLine="Socket1.Initialize(\"Socket1\")";
_socket1.Initialize("Socket1");
 };
 //BA.debugLineNum = 74;BA.debugLine="Socket1.Connect(SeleccionarMando.nServer,Selecci";
...
public static boolean  _datos_validos() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub Datos_Validos As Boolean";
 //BA.debugLineNum = 58;BA.debugLine="If myIp = \"127.0.0.1\" Then";
if ((_myip).equals("127.0.0.1")) { 
 //BA.debugLineNum = 59;BA.debugLine="Msgbox(\"Verifica tu conexion a la nueva red\",\"AC";
...
mostCurrent._botonpower = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private BotonCanalArriba As Button";
mostCurrent._botoncanalarriba = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private BotonCanalAbajo As Button";
mostCurrent._botoncanalabajo = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private LabelCanal As Label";
mostCurrent._labelcanal = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private BotonMas As Button";
mostCurrent._botonmas = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private BotonMenos As Button";
mostCurrent._botonmenos = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private LabelVolumen As Label";
mostCurrent._labelvolumen = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private BotonGrabarTeclas As Button";
mostCurrent._botongrabarteclas = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private BotonVolver As Button";
mostCurrent._botonvolver = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Private BotonArriba As Button";
mostCurrent._botonarriba = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private BotonAbajo As Button";
mostCurrent._botonabajo = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private BotonIzquierda As Button";
mostCurrent._botonizquierda = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Private BotonDerecha As Button";
mostCurrent._botonderecha = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private BotonOk As Button";
mostCurrent._botonok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private BotonMenu As Button";
mostCurrent._botonmenu = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private BotonTvAv As Button";
mostCurrent._botontvav = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private BotonGuia As Button";
mostCurrent._botonguia = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private BotonPrev As Button";
mostCurrent._botonprev = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private BotonNumerico As Button";
mostCurrent._botonnumerico = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private BotonMute As Button";
mostCurrent._botonmute = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private BotonPowerDeco As Button";
...
public static String  _socket1_connected(boolean _succesful) throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Sub Socket1_Connected(Succesful As Boolean)";
 //BA.debugLineNum = 80;BA.debugLine="If Succesful Then";
if (_succesful) { 
 //BA.debugLineNum = 81;BA.debugLine="AStreams.Initialize(Socket1.InputStream, Socket1";
...
int _i = 0;
byte[] _buffer = null;
 //BA.debugLineNum = 154;BA.debugLine="Sub transmiTrama(numero As Int)";
 //BA.debugLineNum = 155;BA.debugLine="If AStreams.IsInitialized = False Then Return";
if (_astreams.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 156;BA.debugLine="If (myIp = \"127.0.0.1\") = False Then";
if (((_myip).equals("127.0.0.1"))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 157;BA.debugLine="Connection.myCUR = Connection.mySQL.ExecQuery(\"S";
...
_trama = _trama+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 163;BA.debugLine="buffer = Trama.GetBytes(\"UTF8\")";
_buffer = _trama.getBytes("UTF8");
 //BA.debugLineNum = 164;BA.debugLine="AStreams.Write(buffer)";
