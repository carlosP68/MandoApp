...
public class grabarteclastv extends Activity implements B4AActivity{
	public static grabarteclastv mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.grabarteclastv");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (grabarteclastv).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.grabarteclastv");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.grabarteclastv", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (grabarteclastv) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (grabarteclastv) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (grabarteclastv) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (grabarteclastv) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="Activity.LoadLayout(\"LayoutGrabarTeclasTv\")";
mostCurrent._activity.LoadLayout("LayoutGrabarTeclasTv",mostCurrent.activityBA);
...
mostCurrent._spinnerteclas.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Power","Volumen +","Volumen -","Canal +","Canal -","Mute","Boton Ok","Arriba","Abajo","Izquierda","Derecha","Numero 1","Numero 2","Numero 3","Numero 4","Numero 5","Numero 6","Numero 7","Numero 8","Numero 9","Numero 0"}));
...
case 0: {
 //BA.debugLineNum = 99;BA.debugLine="GuardarTramaTv(1)";
_guardartramatv((int) (1));
 break; }
case 1: {
 //BA.debugLineNum = 101;BA.debugLine="GuardarTramaTv(2)";
_guardartramatv((int) (2));
 break; }
case 2: {
 //BA.debugLineNum = 103;BA.debugLine="GuardarTramaTv(3)";
_guardartramatv((int) (3));
 break; }
case 3: {
 //BA.debugLineNum = 105;BA.debugLine="GuardarTramaTv(4)";
_guardartramatv((int) (4));
 break; }
case 4: {
 //BA.debugLineNum = 107;BA.debugLine="GuardarTramaTv(5)";
_guardartramatv((int) (5));
 break; }
case 5: {
 //BA.debugLineNum = 109;BA.debugLine="GuardarTramaTv(6)";
_guardartramatv((int) (6));
 break; }
case 6: {
 //BA.debugLineNum = 111;BA.debugLine="GuardarTramaTv(7)";
_guardartramatv((int) (7));
 break; }
case 7: {
 //BA.debugLineNum = 113;BA.debugLine="GuardarTramaTv(8)";
_guardartramatv((int) (8));
 break; }
case 8: {
 //BA.debugLineNum = 115;BA.debugLine="GuardarTramaTv(9)";
_guardartramatv((int) (9));
 break; }
case 9: {
 //BA.debugLineNum = 117;BA.debugLine="GuardarTramaTv(10)";
_guardartramatv((int) (10));
 break; }
case 10: {
 //BA.debugLineNum = 119;BA.debugLine="GuardarTramaTv(11)";
_guardartramatv((int) (11));
 break; }
case 11: {
 //BA.debugLineNum = 121;BA.debugLine="GuardarTramaTv(12)";
_guardartramatv((int) (12));
 break; }
case 12: {
 //BA.debugLineNum = 123;BA.debugLine="GuardarTramaTv(13)";
_guardartramatv((int) (13));
 break; }
case 13: {
 //BA.debugLineNum = 125;BA.debugLine="GuardarTramaTv(14)";
_guardartramatv((int) (14));
 break; }
case 14: {
 //BA.debugLineNum = 127;BA.debugLine="GuardarTramaTv(15)";
_guardartramatv((int) (15));
 break; }
case 15: {
 //BA.debugLineNum = 129;BA.debugLine="GuardarTramaTv(16)";
_guardartramatv((int) (16));
 break; }
case 16: {
 //BA.debugLineNum = 131;BA.debugLine="GuardarTramaTv(17)";
_guardartramatv((int) (17));
 break; }
case 17: {
 //BA.debugLineNum = 133;BA.debugLine="GuardarTramaTv(18)";
_guardartramatv((int) (18));
 break; }
case 18: {
 //BA.debugLineNum = 135;BA.debugLine="GuardarTramaTv(19)";
_guardartramatv((int) (19));
 break; }
case 19: {
 //BA.debugLineNum = 137;BA.debugLine="GuardarTramaTv(20)";
_guardartramatv((int) (20));
 break; }
case 20: {
 //BA.debugLineNum = 139;BA.debugLine="GuardarTramaTv(21)";
_guardartramatv((int) (21));
 break; }
}
;
...
public static String  _botonvolver_click() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="StartActivity(MandoTV)";
...
if (true) return "";};
 //BA.debugLineNum = 154;BA.debugLine="If MandoTV.myIp.Length > 0 Then";
if (mostCurrent._mandotv._myip /*String*/ .length()>0) { 
 //BA.debugLineNum = 155;BA.debugLine="Dim buffer() As Byte";
_buffer = new byte[(int) (0)];
;
 //BA.debugLineNum = 156;BA.debugLine="Dim str As String = MandoTV.myIp";
_str = mostCurrent._mandotv._myip /*String*/ ;
...
if (_astreams.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 165;BA.debugLine="If (MandoTV.MyIp = \"127.0.0.1\") = False Then";
...
public static boolean  _datos_validos() throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="If MandoTV.myIp = \"127.0.0.1\" Then";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 17;BA.debugLine="Private SpinnerTeclas As Spinner";
mostCurrent._spinnerteclas = new anywheresoftware.b4a.objects.SpinnerWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private LabelTeclaAGrabar As Label";
mostCurrent._labelteclaagrabar = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private BotonLimpiar As Button";
mostCurrent._botonlimpiar = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private PanelTramaRecibida As Panel";
mostCurrent._paneltramarecibida = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private LabelTramaRecibida As Label";
mostCurrent._labeltramarecibida = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private BotonGrabarTecla As Button";
mostCurrent._botongrabartecla = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private EditTextTramaRecibida As EditText";
mostCurrent._edittexttramarecibida = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private BotonVolver As Button";
mostCurrent._botonvolver = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private LabelInstruccion As Label";
mostCurrent._labelinstruccion = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Private BtnProbarTrama As Button";
mostCurrent._btnprobartrama = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 29;BA.debugLine="Private BtnIniciarComunicacion As Button";
mostCurrent._btniniciarcomunicacion = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private Trama As String";
mostCurrent._trama = "";
 //BA.debugLineNum = 31;BA.debugLine="End Sub";
return "";
}
public static String  _guardartramatv(int _numero) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub GuardarTramaTv(numero As Int)";
...
if (mostCurrent._connection._mycur /*anywheresoftware.b4a.sql.SQL.CursorWrapper*/ .getRowCount()>0) { 
 //BA.debugLineNum = 178;BA.debugLine="Connection.mySQL.ExecNonQuery(\"UPDATE TramasTv S";
mostCurrent._connection._mysql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE TramasTv SET Trama='"+mostCurrent._edittexttramarecibida.getText()+"' WHERE id='"+BA.NumberToString(_numero)+"'");
 }else {
 //BA.debugLineNum = 181;BA.debugLine="Connection.mySQL.ExecNonQuery(\"INSERT INTO Trama";
mostCurrent._connection._mysql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("INSERT INTO TramasTv (id,Trama) VALUES('"+BA.NumberToString(_numero)+"','"+mostCurrent._edittexttramarecibida.getText()+"')");
 };
