...
public class grabarteclasdecoder extends Activity implements B4AActivity{
	public static grabarteclasdecoder mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.grabarteclasdecoder");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (grabarteclasdecoder).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.grabarteclasdecoder");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.grabarteclasdecoder", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (grabarteclasdecoder) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (grabarteclasdecoder) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return grabarteclasdecoder.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (grabarteclasdecoder) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (grabarteclasdecoder) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            grabarteclasdecoder mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="Activity.LoadLayout(\"LayoutGrabarTeclasDecoder\")";
mostCurrent._activity.LoadLayout("LayoutGrabarTeclasDecoder",mostCurrent.activityBA);
...
mostCurrent._activity.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"bg.jpg").getObject()));
 //BA.debugLineNum = 37;BA.debugLine="SpinnerTeclas.AddAll(Array As String(\"Power\",\"Pow";
mostCurrent._spinnerteclas.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Power","Power Deco","Volumen +","Volumen -","Canal +","Canal -","Tv/Av","Guia","Menu","Prev","Mute","Ok","Arriba","Abajo","Izquierda","Derecha","numero 1","numero 2","numero 3","numero 4","numero 5","numero 6","numero 7","numero 8","numero 9","numero 0"}));
 //BA.debugLineNum = 38;BA.debugLine="ConectarServidor";
_conectarservidor();
...
public static String  _astreams_error() throws Exception{
 //BA.debugLineNum = 84;BA.debugLine="Sub AStreams_Error";
 //BA.debugLineNum = 86;BA.debugLine="End Sub";
return "";
}
public static String  _astreams_newdata(byte[] _buffer) throws Exception{
String _msg = "";
 //BA.debugLineNum = 77;BA.debugLine="Sub AStreams_NewData(Buffer() As Byte)";
 //BA.debugLineNum = 78;BA.debugLine="Dim msg As String";
_msg = "";
 //BA.debugLineNum = 79;BA.debugLine="msg = BytesToString(Buffer,0,Buffer.Length,\"UTF8\"";
_msg = anywheresoftware.b4a.keywords.Common.BytesToString(_buffer,(int) (0),_buffer.length,"UTF8");
 //BA.debugLineNum = 80;BA.debugLine="ToastMessageShow(msg,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_msg),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 81;BA.debugLine="EditTextTramaRecibida.Text = \"\"";
mostCurrent._edittexttramarecibida.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 82;BA.debugLine="EditTextTramaRecibida.Text = msg";
...
public static String  _botongrabartecla_click() throws Exception{
 //BA.debugLineNum = 89;BA.debugLine="Private Sub BotonGrabarTecla_Click";
...
switch (BA.switchObjectToInt(mostCurrent._spinnerteclas.getSelectedIndex(),(int) (0),(int) (1),(int) (2),(int) (3),(int) (4),(int) (5),(int) (6),(int) (7),(int) (8),(int) (9),(int) (10),(int) (11),(int) (12),(int) (13),(int) (14),(int) (15),(int) (16),(int) (17),(int) (18),(int) (19),(int) (20),(int) (21),(int) (22),(int) (23),(int) (24),(int) (25))) {
case 0: {
 //BA.debugLineNum = 99;BA.debugLine="GuardarTramaDeco(1)";
_guardartramadeco((int) (1));
 break; }
case 1: {
 //BA.debugLineNum = 101;BA.debugLine="GuardarTramaDeco(2)";
_guardartramadeco((int) (2));
 break; }
case 2: {
 //BA.debugLineNum = 103;BA.debugLine="GuardarTramaDeco(3)";
_guardartramadeco((int) (3));
 break; }
case 3: {
 //BA.debugLineNum = 105;BA.debugLine="GuardarTramaDeco(4)";
_guardartramadeco((int) (4));
 break; }
case 4: {
 //BA.debugLineNum = 107;BA.debugLine="GuardarTramaDeco(5)";
_guardartramadeco((int) (5));
 break; }
case 5: {
 //BA.debugLineNum = 109;BA.debugLine="GuardarTramaDeco(6)";
_guardartramadeco((int) (6));
 break; }
case 6: {
 //BA.debugLineNum = 111;BA.debugLine="GuardarTramaDeco(7)";
_guardartramadeco((int) (7));
 break; }
case 7: {
 //BA.debugLineNum = 113;BA.debugLine="GuardarTramaDeco(8)";
_guardartramadeco((int) (8));
 break; }
case 8: {
 //BA.debugLineNum = 115;BA.debugLine="GuardarTramaDeco(9)";
_guardartramadeco((int) (9));
 break; }
case 9: {
 //BA.debugLineNum = 117;BA.debugLine="GuardarTramaDeco(10)";
_guardartramadeco((int) (10));
 break; }
case 10: {
 //BA.debugLineNum = 119;BA.debugLine="GuardarTramaDeco(11)";
_guardartramadeco((int) (11));
 break; }
case 11: {
 //BA.debugLineNum = 121;BA.debugLine="GuardarTramaDeco(12)";
_guardartramadeco((int) (12));
 break; }
case 12: {
 //BA.debugLineNum = 123;BA.debugLine="GuardarTramaDeco(13)";
_guardartramadeco((int) (13));
 break; }
case 13: {
 //BA.debugLineNum = 125;BA.debugLine="GuardarTramaDeco(14)";
_guardartramadeco((int) (14));
 break; }
case 14: {
 //BA.debugLineNum = 127;BA.debugLine="GuardarTramaDeco(15)";
_guardartramadeco((int) (15));
 break; }
case 15: {
 //BA.debugLineNum = 129;BA.debugLine="GuardarTramaDeco(16)";
_guardartramadeco((int) (16));
 break; }
case 16: {
 //BA.debugLineNum = 131;BA.debugLine="GuardarTramaDeco(17)";
_guardartramadeco((int) (17));
 break; }
case 17: {
 //BA.debugLineNum = 133;BA.debugLine="GuardarTramaDeco(18)";
_guardartramadeco((int) (18));
 break; }
case 18: {
 //BA.debugLineNum = 135;BA.debugLine="GuardarTramaDeco(19)";
_guardartramadeco((int) (19));
 break; }
case 19: {
 //BA.debugLineNum = 137;BA.debugLine="GuardarTramaDeco(20)";
_guardartramadeco((int) (20));
 break; }
case 20: {
 //BA.debugLineNum = 139;BA.debugLine="GuardarTramaDeco(21)";
_guardartramadeco((int) (21));
 break; }
case 21: {
 //BA.debugLineNum = 141;BA.debugLine="GuardarTramaDeco(22)";
_guardartramadeco((int) (22));
 break; }
case 22: {
 //BA.debugLineNum = 143;BA.debugLine="GuardarTramaDeco(23)";
_guardartramadeco((int) (23));
 break; }
case 23: {
 //BA.debugLineNum = 145;BA.debugLine="GuardarTramaDeco(24)";
_guardartramadeco((int) (24));
 break; }
case 24: {
 //BA.debugLineNum = 147;BA.debugLine="GuardarTramaDeco(25)";
_guardartramadeco((int) (25));
 break; }
case 25: {
 //BA.debugLineNum = 149;BA.debugLine="GuardarTramaDeco(26)";
_guardartramadeco((int) (26));
 break; }
}
;
...
public static String  _botonlimpiar_click() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Private Sub BotonLimpiar_Click";
 //BA.debugLineNum = 153;BA.debugLine="EditTextTramaRecibida.Text = \"\"";
mostCurrent._edittexttramarecibida.setText(BA.ObjectToCharSequence(""));
...
byte[] _buffer = null;
String _str = "";
 //BA.debugLineNum = 160;BA.debugLine="Private Sub BtnIniciarComunicacion_Click";
 //BA.debugLineNum = 162;BA.debugLine="If AStreams.IsInitialized = False Then Return";
if (_astreams.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 164;BA.debugLine="If MandoDecodificador.myIp.Length > 0 Then";
if (mostCurrent._mandodecodificador._myip /*String*/ .length()>0) { 
 //BA.debugLineNum = 165;BA.debugLine="Dim buffer() As Byte";
_buffer = new byte[(int) (0)];
;
 //BA.debugLineNum = 166;BA.debugLine="Dim str As String = MandoDecodificador.myIp";
_str = mostCurrent._mandodecodificador._myip /*String*/ ;
 //BA.debugLineNum = 167;BA.debugLine="str = str & Chr(10) & Chr(13)";
_str = _str+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 168;BA.debugLine="buffer = str.GetBytes(\"UTF8\")";
_buffer = _str.getBytes("UTF8");
 //BA.debugLineNum = 169;BA.debugLine="AStreams.Write(buffer)";
...
byte[] _buffer = null;
 //BA.debugLineNum = 172;BA.debugLine="Private Sub BtnProbarTrama_Click";
 //BA.debugLineNum = 174;BA.debugLine="If AStreams.IsInitialized = False Then Return";
if (_astreams.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 175;BA.debugLine="If (MandoTV.MyIp = \"127.0.0.1\") = False Then";
if (((mostCurrent._mandotv._myip /*String*/ ).equals("127.0.0.1"))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 176;BA.debugLine="Trama = EditTextTramaRecibida.Text";
mostCurrent._trama = mostCurrent._edittexttramarecibida.getText();
 //BA.debugLineNum = 177;BA.debugLine="Dim buffer() As Byte";
_buffer = new byte[(int) (0)];
;
 //BA.debugLineNum = 178;BA.debugLine="Trama = Trama & Chr(10) & Chr(13)";
mostCurrent._trama = mostCurrent._trama+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (13)));
 //BA.debugLineNum = 179;BA.debugLine="buffer = Trama.GetBytes(\"UTF8\")";
_buffer = mostCurrent._trama.getBytes("UTF8");
 //BA.debugLineNum = 180;BA.debugLine="AStreams.Write(buffer)";
_astreams.Write(_buffer);
 };
...
public static String  _conectarservidor() throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Sub ConectarServidor";
 //BA.debugLineNum = 56;BA.debugLine="Try";
try { //BA.debugLineNum = 57;BA.debugLine="If Datos_Validos = False Then Return";
if (_datos_validos()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 59;BA.debugLine="If Socket1.IsInitialized = False Then";
if (_socket1.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 60;BA.debugLine="Socket1.Initialize(\"Socket1\")";
_socket1.Initialize("Socket1");
 }else {
 //BA.debugLineNum = 62;BA.debugLine="Socket1.Close";
_socket1.Close();
 //BA.debugLineNum = 63;BA.debugLine="Socket1.Initialize(\"Socket1\")";
_socket1.Initialize("Socket1");
 };
 //BA.debugLineNum = 65;BA.debugLine="Socket1.Connect(SeleccionarMando.nServer,Selecci";
...
public static boolean  _datos_validos() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub Datos_Validos As Boolean";
 //BA.debugLineNum = 49;BA.debugLine="If MandoDecodificador.myIp = \"127.0.0.1\" Then";
if ((mostCurrent._mandodecodificador._myip /*String*/ ).equals("127.0.0.1")) { 
 //BA.debugLineNum = 50;BA.debugLine="Msgbox(\"Verifica tu conexion a la nueva red\",\"AC";
...
public static String  _guardartramadeco(int _numero) throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Sub GuardarTramaDeco(numero As Int)";
 //BA.debugLineNum = 185;BA.debugLine="Connection.myCUR = Connection.mySQL.ExecQuery(\"SE";
mostCurrent._connection._mycur /*anywheresoftware.b4a.sql.SQL.CursorWrapper*/  = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._connection._mysql /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery("SELECT Trama FROM TramasDecodificador WHERE id='"+BA.NumberToString(_numero)+"'")));
 //BA.debugLineNum = 186;BA.debugLine="If Connection.myCUR.RowCount > 0 Then";
if (mostCurrent._connection._mycur /*anywheresoftware.b4a.sql.SQL.CursorWrapper*/ .getRowCount()>0) { 
 //BA.debugLineNum = 188;BA.debugLine="Connection.mySQL.ExecNonQuery(\"UPDATE TramasDeco";
mostCurrent._connection._mysql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("UPDATE TramasDecodificador SET Trama='"+mostCurrent._edittexttramarecibida.getText()+"' WHERE id='"+BA.NumberToString(_numero)+"'");
 }else {
 //BA.debugLineNum = 191;BA.debugLine="Connection.mySQL.ExecNonQuery(\"INSERT INTO Trama";
mostCurrent._connection._mysql /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery("INSERT INTO TramasDecodificador (id,Trama) VALUES('"+BA.NumberToString(_numero)+"','"+mostCurrent._edittexttramarecibida.getText()+"')");
 };
 //BA.debugLineNum = 193;BA.debugLine="ToastMessageShow(\"Tecla Grabada\",False)";
...
public static String  _socket1_connected(boolean _succesful) throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub Socket1_Connected(Succesful As Boolean)";
 //BA.debugLineNum = 71;BA.debugLine="If Succesful Then";
if (_succesful) { 
 //BA.debugLineNum = 72;BA.debugLine="AStreams.Initialize(Socket1.InputStream, Socket1";
